...
namespace ProjectDemo.BLL
{
	...
	{
		private readonly ProjectDemo.DAL.FriendlyLinkDAL dal=new ProjectDemo.DAL.FriendlyLinkDAL();
		...
		{
			return dal.DeleteList(ProjectDemo.Common.PageValidate.SafeLongFilter(LinkIdlist,0) );
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ProjectDemo.Model.FriendlyLink GetModelByCache(int LinkId)
		{
			...
			return (ProjectDemo.Model.FriendlyLink)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ProjectDemo.Model.FriendlyLink> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ProjectDemo.Model.FriendlyLink> DataTableToList(DataTable dt)
		{
			List<ProjectDemo.Model.FriendlyLink> modelList = new List<ProjectDemo.Model.FriendlyLink>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ProjectDemo.Model.FriendlyLink model;
